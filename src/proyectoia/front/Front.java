...
@Deprecated
    ...
    /*
        SortedSet<String> keys = new TreeSet<String>(miMundo.keySet());
        
        //Iterator it = miMundo.entrySet().iterator();
        for (String key : keys){
            Map.Entry actual = (Map.Entry)miMundo.get(key);
            
            JLabel bt = (JLabel)actual.getValue();
            bt.setSize(32, 32);
            bt.setVisible(true);
            panelMundo.add(bt);
